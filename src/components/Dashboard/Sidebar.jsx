...
function Sidebar({ isOpen, setIsOpen, onLinkClick,activeLink }) {
  ...
  return (
    <div className="relative">
      ...
      <div
        className={`fixed top-0 left-0 h-full !bg-myBlue text-white w-72 p-4 z-40 transition-transform duration-300 ease-in-out transform ${
        ...
        <div className="sidebar-nav">
          <ul className="menu vertical space-y-4">
            <li>
              <a
                href="#"
                className={`flex items-center space-x-2 ${activeLink === 'dashboard' ? 'bg-white !text-myBlue hover:!bg-white' : ''}`}
            ...
            <li>
              <a
                href="#"
                className={`flex items-center space-x-2 ${activeLink === 'courses' ? 'bg-white !text-myBlue hover:!bg-white'  : ''}`}
            ...
            <li>
              <a
                href="#"
                className={`flex items-center space-x-2 ${activeLink === 'support' ? 'bg-white !text-myBlue hover:!bg-white' : ''}`}
            ...
            <li>
              <a
                href="#"
                className={`flex items-center space-x-2 ${activeLink === 'Feedback' ? 'bg-white !text-myBlue hover:!bg-white' : ''}`}
